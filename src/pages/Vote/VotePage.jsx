    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center p-4 animate-in fade-in duration-700">
        <div className="max-w-md w-full text-center">
          <div className="w-24 h-24 bg-zinc-900 rounded-full flex items-center justify-center mx-auto mb-8 shadow-[0_0_40px_rgba(255,255,255,0.15)]">
            <Trophy className="w-12 h-12 text-white" />
          </div>
          <h2 className="text-4xl font-black text-white mb-4 tracking-tight">You're on fire!</h2>
          <p className="text-lg text-zinc-400 mb-2">
            You voted on <strong className="text-white font-bold">{votedCount}</strong> battles today.
          </p>
      ...
      <main className="w-full max-w-4xl px-4 py-8 animate-in fade-in slide-in-from-bottom-8 duration-500" key={battle.id}>
        ...
        <div className="flex flex-wrap items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg font-bold text-white tracking-tight">{battle.category}</span>
          </div>

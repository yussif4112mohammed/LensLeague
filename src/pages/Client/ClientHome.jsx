        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
          {photos.slice(0, 6).map(photo => (
            <div key={photo.id} className="relative rounded-2xl overflow-hidden cursor-pointer group" onClick={() => navigate(`/profile/${photo.ownerId}`)}>
              <img src={photo.url} alt={photo.caption} className="w-full object-cover transition-transform duration-500 group-hover:scale-105" style={photo.aspectRatio ? { aspectRatio: photo.aspectRatio } : undefined} />
